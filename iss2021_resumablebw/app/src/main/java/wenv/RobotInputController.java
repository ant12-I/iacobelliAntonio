...
private wenv.RobotBoundaryLogic robotBehaviorLogic  ;
private IssCommSupport     commSupport;  //IssArilRobotSupport
    ...
    public RobotInputController(IssCommSupport support, boolean usearil, boolean doMap){
        commSupport = support;
        robotBehaviorLogic = new wenv.RobotBoundaryLogic(support, usearil, doMap);
     }
...
- a collision between the robot and an obstacle { "collision" : "false", "move": "moveForward"}
    ...
    protected void handleGui( JSONObject commandGui ){
        String com = (String) commandGui.get("robotcmd");
        switch (com){
            case "STOP": robotBehaviorLogic.Stop(); break;
