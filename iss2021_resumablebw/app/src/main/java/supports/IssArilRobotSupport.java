...
public class IssArilRobotSupport implements supports.IssCommSupport {
    private supports.IssCommSupport support;
    private static HashMap<String, Integer> timemap = new HashMap<String, Integer>( );

    public IssArilRobotSupport(Object supportedObj, supports.IssCommSupport support){
        this.support   = support;
        IssAnnotationUtil.getMoveTimes( supportedObj, timemap );
        timemap.forEach(  ( k,v ) -> System.out.println(""+k+":"+v));
    }
    public IssArilRobotSupport( String robotConfigFile, supports.IssCommSupport support){
