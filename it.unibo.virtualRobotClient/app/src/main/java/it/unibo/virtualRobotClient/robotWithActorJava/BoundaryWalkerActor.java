package it.unibo.virtualRobotClient.robotWithActorJava;
...
public class BoundaryWalkerActor extends ActorBasicJava {
    ...
    private State preStat  = State.start;
...
*/
    ...
    protected void fsm(String move, String endmove){
        ...
        switch( curState ) {
            ...
            case walking: {
                ...
                else if (move.equals("moveForward")  && endmove.equals("true") && !robotHalted){
                    //curState = State.walk;
                    moves.updateMovesRep("w");
                    doStep();
                 } else if (move.equals("moveForward")  && endmove.equals("false") && !robotHalted) {
            ...
            case obstacle :
                ...
                else if( move.equals("turnLeft") && endmove.equals("true") && !robotHalted) {
                    if( stepNum < 4 ) {
                        stepNum++;
    ...
    protected void msgDriven( JSONObject infoJson){
        ...
        else if( infoJson.has("robotcmd") )
            fsm((String)  infoJson.get("robotcmd"), "");
